...
print(tokenize_ger("ein pferd geht unter einer brücke neben einem boot"))
# ['ein', 'pferd', 'geht', 'unter', 'einer', 'brücke', 'neben', 'einem', 'boot']
print(tokenize_eng("A horse walks under a bridge next to a boat"))
# ['A', 'horse', 'walks', 'under', 'a', 'bridge', 'next', 'to', 'a', 'boat']

# 这里定义了两个Field对象，分别用于德语和英语
# tokenize: 分词函数，这里分别传入了tokenize_ger和tokenize_eng
